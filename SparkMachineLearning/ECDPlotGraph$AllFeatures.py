...
f1 = [pointDataItem[0] for pointDataItem in pointData]
f2 = [pointDataItem[1] for pointDataItem in pointData]
f3 = [pointDataItem[2] for pointDataItem in pointData]
f4 = [pointDataItem[3] for pointDataItem in pointData]
f5 = [pointDataItem[4] for pointDataItem in pointData]


plt.plot(f1, 'g-', label='T10Y3M')
plt.plot(f2, 'b-', label='INDPRO')
plt.plot(f3, 'r-', label='CCSA')
plt.plot(f4, 'c-', label='S&P 500')
